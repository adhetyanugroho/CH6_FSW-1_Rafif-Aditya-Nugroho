...
import logo_bawah from "../assets/images/logo_bawah.png"
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 connect pt-2">
                            ...
                            <div className="row row-cols-auto">
                                <div className="col">
                                    <img src={icon_facebook} alt="icon_facebook.png" />
                                </div>
                                <div className="col">
                                    <img src={icon_instagram} alt="icon_instagram.png" />
                                </div>
                                <div className="col">
                                    <img src={icon_twitter} alt="icon_twitter.png" />
                                </div>
                                <div className="col">
                                    <img src={icon_mail} alt="icon_mail.png" />
                                </div>
                                <div className="col">
                                    <img src={icon_twitch} alt="icon_twitch.png" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4 copyright pt-2">
                            ...
                            <img src={logo_bawah} alt="logo_bawah.png" />
                        </div>
                    </div>
                </div>
            </section>
